...
public class Display implements Runnable {
  ...
  /**
   * This is the default constructor. It takes a TextLCD and throws an OdometerExceptions
   * 
   * @param lcd
  ...
  /**
   * This is an overloaded Display constructor In addition to the default constructor, you can set a
   * timeout.
   * 
   * @param lcd
   * @param timeout
